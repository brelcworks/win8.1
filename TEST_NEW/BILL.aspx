            ...
            <ContentTemplate>
                ...
                <div style="width: 99%; margin-right: 1%; margin-left: 1%; text-align: left; height: 305px; overflow: auto; padding: 5px; margin: 5px">
                    <asp:Panel ID="pnldg" runat="server" CssClass="left">
                        ...
                        <asp:GridView ID="dg1" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="BILLID" RowStyle-Font-Size="Smaller" RowStyle-Wrap="false" HeaderStyle-Font-Size="Smaller">
                            <Columns>
