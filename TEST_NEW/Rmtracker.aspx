<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rmtracker.aspx.vb" Inherits="TEST_NEW.Rmtracker" %>
...
<head runat="server">
    ...
    <title>B & R ELECTRICAL WORKS (RM- TRACKER)</title>
...
<body style="background-color: lightcyan">
    ...
    <nav class="navbar navbar-inverse">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="RECID1" CssClass="table table-hover table-striped" Width="940px" HorizontalAlign="Center"  RowStyle-Wrap="false" AllowSorting="True" HeaderStyle-BackColor="YellowGreen" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false" Font-Size="Smaller">
              ...
              <asp:Panel ID="pnlAddEdit" runat="server" CssClass="modalPopup " Style="display: none">
                ...
                <table id="tblview" class="table table-bordered">
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="Record Id"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="Site Id"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="sid" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text="Name of OEA"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label7" runat="server" Text="DG Set No"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label8" runat="server" Text="KVA"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label9" runat="server" Text="Model No"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="Alt. Make"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:ComboBox ID="stype1" runat ="server" AutoCompleteMode="Append"></asp:ComboBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label11" runat="server" Text="Batt. Sr. No"></asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="ttr" runat="server"></asp:TextBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label33" runat="server" Text="Time Slot"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="tslot" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label34" runat="server" Text="Dealer Code"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label36" runat="server" Text="Meterial Used"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="meterial" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label37" runat="server" Text="Next Service Dt."></asp:Label>
                        </td>
                        <td>
                     ...
                     <tr>
                        <td>
                            <asp:Label ID="Label38" runat="server" Text="AVG. HMR"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="ahm" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label39" runat="server" Text="HMR Ageing"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="hmage1" runat="server"></asp:TextBox>
                        </td>
                        <td>
                            <asp:Label ID="Label40" runat="server" Text="User Name"></asp:Label>
                        </td>
                        <td>
         ...
         <div style ="width :60%; text-align :center ">
                 <table id="tblFILTER" class="table table-responsive">
                 <tr>
                     <td>
                         <asp:Label ID="DTFRMLBL" runat="server" Text="FROM DATE" CssClass ="form-group-sm "></asp:Label>
                          <asp:TextBox ID="DTFROM" runat="server" CssClass ="form-group-sm "></asp:TextBox>
                         <asp:ImageButton ID="imgPopup" ImageUrl="Design/calendar.png" ImageAlign="Bottom" runat="server" />
                          <asp:CalendarExtender ID="DOSCLNDR" runat="server" TargetControlID="DTFROM" PopupButtonID="imgPopup" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                           <asp:Label ID="Label1" runat="server" Text="TO DATE" CssClass ="form-group-sm "></asp:Label>
                          <asp:TextBox ID="DTTO" runat="server" CssClass ="form-group-sm  "></asp:TextBox>
                          <asp:ImageButton ID="ImageButton1" ImageUrl="Design/calendar.png" ImageAlign="Bottom" runat="server" />
                          <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="DTTO" PopupButtonID="ImageButton1" Format="dd-MMM-yyyy"></asp:CalendarExtender>
                          <asp:Button ID="FIND" runat ="server" CssClass ="btn btn-info btn-xs " Text ="FIND" />
                         <asp:Button ID="EXPORT" runat ="server" CssClass ="btn btn-primary  btn-xs " Text ="EXPORT" />
                         <asp:Button ID="btnAdd" runat="server" Text="Add New Record" CssClass="btn btn-success  btn-xs" BackColor="LightCyan" BorderStyle="None" />
                     </td>
                 </tr>
             </table>
            </div> 
